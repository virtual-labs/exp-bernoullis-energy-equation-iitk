...
function waterFlow11() {
  ...
  if (shouldStop) {
    ...
    setTimeout(function () {
      ...
      document.getElementById("steps").innerHTML =
        "Take note of the manometer readings, and then close the gate valve using the close gate valve button.";
...
function fillTankFront(h) {
  ...
  setTimeout(function () {
    document.getElementById("steps").innerHTML =
      "Take note of the current time and current height, and then readjust the value of valve positioning to get further readings";
    valvePositioning.disabled = false;
...
function waterTankBackFlow(y, h) {
  if (y > h) {
    ...
    waterTankBack.setAttribute(
      "points",
      `245.1,${y} 587.9,${y} 587.9,551.2 245.1,551.2`
    );
    if (valvePositioning.value == 1) {
...
function waterTankSideFlow(y1, y2, h) {
  if (y1 > h) {
    ...
    waterTankLeft.setAttribute(
      "points",
      `245.2,550 187.2,620.6 187.2,${y1} 244.8,${y2}`
    );
    if (valvePositioning.value == 1) {
...
function reset() {
  ...
  waterTankBack.setAttribute(
    "points",
    "245.1,551.2 587.9,551.2 587.9,551.2 245.1,551.2"
  );
  waterTankFront.setAttribute("opacity", "0");
  waterTankLeft.setAttribute(
    "points",
    "245.2,550 187.2,620.6 187.2,620.6 244.8,550"
  );
